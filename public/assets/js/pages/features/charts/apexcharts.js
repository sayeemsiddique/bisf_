...
var KTApexChartsDemo = function () {
	...
	var _demo12 = function () {
		...
		var totalData = $('#chart_12').attr('data-service1');
		var totalPublication = $('#chart_12').attr('data-service2');
		var totalCertificate = $('#chart_12').attr('data-service3');

		var options = {
			series: [Number(totalData), Number(totalPublication), Number(totalCertificate)],
			chart: {
				width: 450,
				type: 'pie',
			},
			labels: ['Data Sale Service', 'Publication Sale Service', 'Certificate Sale Service'],
			responsive: [{
				breakpoint: 480,
				options: {
					chart: {
