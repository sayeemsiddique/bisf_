				...
				<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						...
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							<!--begin::Page Title-->
							<h5 class="text-dark font-weight-bold my-1 mr-5">Add New Corporate Consumer</h5>
							<!--end::Page Title-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								@can('all_corporates')
									<li class="breadcrumb-item">
										<a href="{{route('admin.customer.all_corporate')}}" class="text-muted">All Corporate Consumers</a>
									</li>
								@endcan
								
								<li class="breadcrumb-item active">
									<a class="text-muted">Add New Corporate Consumer</a>
								</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						...
						<div class="col-lg-12">
							...
							<div class="card card-custom example example-compact">
								<div class="card-header">
									<h3 class="card-title">Add New Corporate Consumer</h3>
								...
								<form class="form" action="{{route('admin.customer.store')}}" method="post" id="kt_form_1" enctype="multipart/form-data">
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-lg-5 col-sm-12">
												<input type="text" class="form-control" name="corporation_name" placeholder="Enter Corporation Name" value="{{old('corporation_name')}}" required id="corporation_name" oninput="username()" />
											</div>
										</div>
