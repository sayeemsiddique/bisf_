									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item active">
												<a class="text-muted">Edit {{ $product->name }}</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{route('admin.product.update', $product->id)}}" method="post" id="kt_form_1" enctype="multipart/form-data">
												@csrf
                                                @method('patch')
												...
												<div class="card-body">
                                                    ...
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-4 col-sm-12">Product Name *</label>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
															<textarea placeholder="Description" class="form-control summernote" name="description" id="" cols="30" rows="10">{{$product->description}}</textarea>
														</div>
													</div>

													<div class="form-group row">
														<label class="col-form-label text-right col-lg-4 col-sm-12">
															<img style="width: 50px" src="{{asset('storage/product')}}/{{$product->image}}" alt="">
															Image:
														</label>
														<div class="col-lg-5 col-sm-12">
													...
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-4 col-sm-12">
															<img style="width: 50px" src="{{asset('storage/product')}}/{{$product->banner}}" alt="">
															Banner:</label>
														<div class="col-lg-5 col-sm-12">
