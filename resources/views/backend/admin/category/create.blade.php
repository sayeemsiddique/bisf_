								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											@can('all_department')
												<li class="breadcrumb-item">
													<a href="{{route('admin.department.index')}}" class="text-muted">Manage Category</a>
												</li>
											@endcan
											
											<li class="breadcrumb-item active">
												<a class="text-muted">Add New Category</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{route('admin.category.store')}}" method="post" id="kt_form_1" enctype="multipart/form-data">
												@csrf
												...
												<div class="card-body">
													...
													<div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
															<input type="text" class="form-control" name="sl" placeholder="Enter Category serial" value="{{old('sl')}}"/>
														</div>
													</div>
													<div class="form-group row">
