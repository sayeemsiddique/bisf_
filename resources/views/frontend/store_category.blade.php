        ...
        <div class="row mb-8">
            <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                <div class="mb-8 border border-width-2 border-color-3 borders-radius-6">
                    ...
                    <ul id="sidebarNav" class="list-unstyled mb-0 sidebar-navbar">
                        <li>
                            ...
                            <div id="sidebarNav1Collapse" class="collapse" data-parent="#sidebarNav">
                                <ul id="sidebarNav1" class="list-unstyled dropdown-list">
                                    ...
                                    <li><a class="dropdown-item" href="#">Insulator<span class="text-gray-25 font-size-12 font-weight-normal"> (11)</span></a></li>
                        ...
                        <li>
                            <a class="dropdown-current active" href="#">Insulator <span class="text-gray-25 font-size-12 font-weight-normal"> (50)</span></a>
                ...
                <div class="mb-8">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="{{route('product-detail',1)}}" class="d-block width-75">
                                        <img class="img-fluid" src="{{asset('frontend/assets/img/300X300/img1.jpg')}}" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{route('product-detail',1)}}">Notebook Black Spire V Nitro VN7-591G</a></h3>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{route('product-detail',1)}}">Tablet Thin EliteBook Revolve 810 G6</a></h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{route('product-detail',1)}}">Notebook Purple G952VX-T7008T</a></h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{route('product-detail',1)}}">Laptop Yoga 21 80JH0035GE W8.1</a></h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
            ...
            <div class="col-xl-9 col-wd-9gdot5">
                ...
                <div class="d-block d-md-flex flex-center-between mb-3">
                    ...
                    <p class="font-size-14 text-gray-90 mb-0">Showing {{$i}}–{{$products->perPage() + ($i - 1)}} of {{$products->total()}} results</p>
                </div>
                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="mb-1 product-item__title"><a href="{{route('product-detail', $product->id)}}" class="text-blue font-weight-bold">{{$product->name}}</a></h5>
                                            <div class="mb-2">
                                                <a href="{{route('product-detail', $product->id)}}" class="d-block text-center"><img class="img-fluid" src="{{asset('frontend/assets/img/besin.png')}}" alt="Image Description"></a>
                                            </div>
                ...
                <nav class="d-md-flex justify-content-between align-items-center border-top pt-3" aria-label="Page navigation example">
                    ...
                    <div class="text-center text-md-left mb-3 mb-md-0">Showing {{$i}}–{{$products->perPage() + ($i - 1)}} of {{$products->total()}} results</div>
